package pl.inder00.opensource.sectors.bungeecord.api.impl;
...
public class SectorsStreamImpl<T extends Message> implements ISectorsStream<T> {
    ...
    private final ISectorsStream.Manager<T> streamManager;

    /**
     * Implementation
     */
    public SectorsStreamImpl(Plugin apiPlugin, ISector sector, Data<T> streamListener, IStreamEmiter<Payload> streamEmiter, Map<Class<?>, Integer> channelsMap) {
     ...
     * Implementation
     */
    public SectorsStreamImpl(Plugin apiPlugin, ISector sector, Data<T> streamListener, IStreamEmiter<Payload> streamEmiter, Subscriber<Payload> streamSubscriber, Map<Class<?>, Integer> channelsMap) {
        this.apiPlugin = apiPlugin;
        this.sector = sector;
        this.streamListener = streamListener;
        this.streamEmiter = streamEmiter;
